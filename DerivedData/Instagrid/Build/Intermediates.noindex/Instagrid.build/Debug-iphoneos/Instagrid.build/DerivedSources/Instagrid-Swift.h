...
#ifndef INSTAGRID_SWIFT_H
#define INSTAGRID_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Instagrid",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC9Instagrid11AppDelegate")
...
SWIFT_CLASS("_TtC9Instagrid13SceneDelegate")
...
SWIFT_CLASS("_TtC9Instagrid14ViewController")
...
- (void)viewDidLoad;
- (IBAction)button1Pressed:(UIButton * _Nonnull)sender;
- (IBAction)button2Pressed:(UIButton * _Nonnull)sender;
- (IBAction)button3Pressed:(UIButton * _Nonnull)sender;
